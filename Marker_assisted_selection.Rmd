...
outtab <- left_join(outtab, top10tab, by = "SNP_ID")
```

We'll add in linkage disequilibrium and trait association data.
...
### Add GC content, number of flanking SNPs
### Make fn to identify which allele is associated with increase in trait value
```
